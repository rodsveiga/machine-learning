...
class Environment(object):
    ...
    def reset(self, testing=False):
        ...
        for traffic_light in six.itervalues(self.intersections):
            traffic_light.reset()
        ...
        # Initialize agent(s)
        for agent in six.iterkeys(self.agent_states):
    ...
    def step(self):
        ...
        for intersection, traffic_light in six.iteritems(self.intersections):
    ...
    def sense(self, agent):
        ...
        left = None
        right = None
        for other_agent, other_state in six.iteritems(self.agent_states):
