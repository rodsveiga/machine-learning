...
class Simulator(object):
    ...
    def run(self, n_test=10, tolerance=0.05):
        ...
        while True:
            ...
            print("/-------------------------")
            if testing:
                print("| Testing trial {}".format(str(trial)) )
            else:
                print("| Training trial {}".format(str(trial)) )
    ...
    def render(self, trial, testing=False):
        ...
        for intersection, traffic_light in six.iteritems(self.env.intersections):
        ...
        # * Dynamic elements
        self.font = self.pygame.font.Font(None, 20)
        for agent, state in six.iteritems(self.env.agent_states):
