...
class LearningAgent(Agent):
    ...
    def __init__(self, env, learning=False, epsilon=1.0, alpha=0.5, a_param = 0.99):
    ...
    def reset(self, destination=None, testing=False):
        ...
        if testing:
            ...
            #self.epsilon = self.epsilon * math.exp(-self.a_param * self.t)
            self.epsilon = self.epsilon * ( self.a_param**self.t)
            self.t += 0.01
    ...
    def choose_action(self, state):
        ...
        if self.learning:
            if self.epsilon > random.random():
                ...
                actions_Q_highest = [ i for i,j in self.Q[state].items() if j==self.get_maxQ(state) ]
