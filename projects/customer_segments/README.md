...
This project requires **Python 2.7** (*we have chosen to complete this project in Python 3.6, then we had to update the code in various places including all relevant print statements) and the following Python libraries installed:
